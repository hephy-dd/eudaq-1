...
namespace {
  auto dummy =
      eudaq::Factory<eudaq::Producer>::Register<PyProducer, const std::string &,
                                                const std::string &>(
...
public:
  ...
  void DoInitialise() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoInitialise);
  }
  void DoConfigure() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoConfigure);
  }
  int GetRunNumber() {
    PYBIND11_OVERLOAD(int, /* Return type */
                      eudaq::Producer, GetRunNumber);
  }
  void DoStartRun() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoStartRun);
  }
  void DoStopRun() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoStopRun);
  }
  void DoStatus() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoStatus);
  }
  void DoReset() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoReset);
  }
  void DoTerminate() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, DoTerminate);
  }

  void RunLoop() override {
    PYBIND11_OVERLOAD(void, /* Return type */
                      eudaq::Producer, RunLoop);
  }
};
...
void init_pybind_producer(py::module &m) {
  ...
  producer_.def(
      py::init([](const std::string &name, const std::string &runctrl) {
        return PyProducer::Make("PyProducer", name, runctrl);
      }));
  ...
  producer_.def("SendEvent", &eudaq::Producer::SendEvent, "Send an Event",
                py::arg("ev"));
  ...
  producer_.def("GetConfigKeys", [](const eudaq::Producer &p) {
    return p.GetConfiguration()->Keylist();
  });
